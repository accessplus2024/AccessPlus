...
useHead({
  ...
  meta: [
    ...
    { 
      name: "description", 
      content: "Fique por dentro das últimas novidades sobre oportunidades educacionais. Newsletter gratuita da Access+ com dicas, insights e oportunidades para jovens." 
    },
...
const loadPosts = async () => {
  try {
    ...
    error.value = 'Erro ao carregar os posts da newsletter. Tente novamente mais tarde.'
...
<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="container mx-auto px-6 py-16 max-w-7xl">
      ...
      <div v-if="!loading && !error" id="newsletter-posts">
        ...
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-gray-600 max-w-2xl mx-auto">
            Descubra insights, dicas e oportunidades que podem transformar sua jornada educacional.
          </p>
        </div>
        ...
        <div v-if="posts.length === 0" class="text-center py-20">
          ...
          <h3 class="text-2xl font-bold text-gray-800 mb-4">Nenhum post encontrado</h3>
          <p class="text-gray-600">Em breve teremos novos conteúdos para você!</p>
        </div>
        ...
        <div v-else>
          ...
          <!-- Pagination -->
          <div v-if="totalPages > 1" class="flex justify-center items-center gap-2" data-aos="fade-up">
            <!-- Previous Button -->
            <button
      ...
      <section class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 md:p-12 mt-20" data-aos="fade-up">
        <div class="text-center">
          <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
            Não perca nenhuma novidade!
          </h3>
          <p class="text-white/90 mb-8 max-w-2xl mx-auto">
            Inscreva-se na nossa newsletter e receba semanalmente as melhores oportunidades e dicas 
            para turbinar sua jornada educacional.
          </p>
          <a
            href="#" 
            target="_blank"
