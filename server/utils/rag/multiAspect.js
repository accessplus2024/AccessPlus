...
export async function searchByAspect(cat, bio, analysis, aspecto, { porLado = 40 } = {}) {
  ...
  const lex = bm25Search(cat.index, termosAsp, { boostPorTermo: boostAsp, topK: porLado }).map((r) => cat.corpus[r.docIdx].id);
